...
oggetti minuscoli che si muovono in un CB 8x8) è possibile suddividere il
\emph{coding block} in \emph{prediction block}, che non seguono la struttura 
a quadtree dei blocchi precedenti:
\begin{figure}[H]
  \centering
